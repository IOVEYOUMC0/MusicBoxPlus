...
// Fired when a player is about to be stopped. Cancelling the event aborts the stop and leaves
// the player running.
public class MusicBoxStopEvent extends Event implements Cancellable {
    ...
    public MusicBoxStopEvent(MusicBoxSongPlayer player) {
        this.player = player;
    ...
    // The song playing at the moment of the stop; null when there was none.
