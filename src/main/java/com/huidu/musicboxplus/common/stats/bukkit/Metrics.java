package com.huidu.musicboxplus.common.stats.bukkit;

import com.huidu.musicboxplus.common.stats.MetricsBase;
import com.huidu.musicboxplus.common.stats.charts.CustomChart;
import com.huidu.musicboxplus.common.stats.json.JsonObjectBuilder;
...
// bStats template code; its Bukkit touchpoints (YamlConfigurationOptions.header(String),
// Plugin.getDescription()) are deprecated with no Paper 1.21.4 replacement, so the class
// keeps a class-level suppression.
    ...
    public Metrics(JavaPlugin plugin, int serviceId) {
        ...
        if (!config.isSet("serverUuid")) {
            ...
            try {
                ...
                // Best effort: if the file cannot be written, metrics still run off the
                // in-memory defaults.
            }
        }
